VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Entrada 
   Caption         =   "Entrada"
   ClientHeight    =   7815
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13500
   OleObjectBlob   =   "Form_Entrada.frx":0000
...
Fornecedor = UCase(Fornecedor.Value)
...
End Sub
Sub txparalv()
If Nome1.Value <> "" And Data.Value <> "" And Quantidade.Value <> "" And valor.Value <> "" And Fornecedor.Value <> "" Then
Dim Data1 As Date
On Error GoTo erro
Data1 = Data
Dim i As Integer
...
ListBox1.List(i, 5) = Fornecedor.Value
